  ...
  return (
    <div name="home" className="bg-[#0a192f] w-full flex justify-center items-center lg:pt-40 lg:pb-40 lg:py-40 py-20 mt-[-2px] dark:bg-white dark:text-[#0a192f]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col  justify-center h-full">
        ...
        <p className="text-[#8892b0] py-4 max-w-[700px]">I used to believe that being a web developer would involve secluded cubicle work, with headphones on, tirelessly debugging and constructing the next groundbreaking technology that would revolutionize the world. However, as I gained experience over the past 8+ years in the industry, it became clear that I haven't quite had that exact experience. Being a web developer is actually more focused on identifying the optimal solution for the problem at hand. This can involve writing code, and exploring third-party solutions.</p>
        <div>
